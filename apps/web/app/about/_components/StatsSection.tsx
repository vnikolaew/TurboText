   ...
   return (
      <section id={`stats`} className={`text-left flex flex-col items-start gap-4`}>
         ...
         <p className={`!text-secondary`}>
            <ul>
               <li> <b className={`text-accent`}>wpm</b> - total number of characters in the correctly typed words (including spaces), divided by 5 and normalised to 60 seconds. </li>
