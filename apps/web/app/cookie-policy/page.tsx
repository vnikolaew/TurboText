   ...
   return (
      <section className={`my-12 flex w-full flex-col items-center`}>
         ...
         >
            ...
            <p className={`mt-2`}>
               Welcome to {APP_NAME} ("we," "us," "our"). This Cookie Policy
               explains how we use cookies and similar technologies to recognize
               you when you visit our website at {APP_HOST_NAME}
            ...
            <h3 className={`mt-2 font-semibold`}>2. User Content</h3>
            <p className={`mt-2`}>
            ...
            <p className={`mt-2`}>
               ...
               areas of our Website may be restricted. As the means by which you
            ...
            <Heading
               text={`7. How often will you update this Cookie Policy?`}
            />
            <p className={`mt-2`}>
...
const CompanyDetails = () => (
   <Fragment>
      ...
      <p>
         {COMPANY_DETAILS.city}, {COMPANY_DETAILS.zipCode}
      </p>
