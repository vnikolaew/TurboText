   ...
   return (
      <section className={`my-12 flex w-full flex-col items-center`}>
         ...
         >
            ...
            <p className={`mt-2`}>
               Welcome to {APP_NAME} ("we," "our," "us"). We are committed to
               ...
               {APP_HOST_NAME}.com, use our services, or interact with us in any
               other way.
            </p>
            ...
            <p className={`mt-2`}>
               ...
               <ul className={`list-disc`}>
                  <li className={`ml-4 mt-2`}>
                     ...
                     billing information, and any other information you provide
                     to us.
                  </li>
                  <li className={`ml-4 mt-2`}>
                     Usage Data: Information about how you use our website and
                     services, such as your IP address, browser type, access
                     times, and pages visited.
                  </li>
                  <li className={`ml-4 mt-2`}>
                     Cookies and Tracking Technologies: We use cookies and
                     similar technologies to track your activity on our website
                     and store certain information. You can control the use of
            ...
            <p className={`mt-2`}>
               ...
               <ul className={`list-disc`}>
                  ...
                  <li className={`ml-4 mt-2`}>Find and prevent fraud.</li>
                  <li className={`ml-4 mt-2`}>
            ...
            <p className={`mt-2`}>
               ...
               <ul className={`list-disc`}>
                  <li className={`ml-4 mt-2`}>
                     Service Providers: Third-party vendors and other service
                  ...
                  <li className={`ml-4 mt-2`}>
                     Legal Requirements: When required by law or to respond to
                     legal process, we may disclose your information to legal
            ...
            <p className={`mt-2`}>
               We implement reasonable security measures to protect the security
               of your information. However, no security system is impenetrable,
               and we cannot guarantee the security of our systems 100%. In the
               event of a data breach, we will notify you and relevant
            ...
            <p className={`mt-2`}>
               ...
               your information, you consent to the transfer of your information
               to our facilities and those third parties with whom we share it
            ...
            <p className={`mt-2`}>
               ...
               <ul className={`list-disc`}>
                  ...
                  <li className={`ml-4 mt-2`}>
                     ...
                     <Link
                        className={`!text-accent`}
                        href={`/privacy-policy?contact=true`}
                     >
                        Contact page
                     </Link>
                  </li>
