...
const Page = ({}: PageProps) => {
   return (
      <section className={`my-12 flex w-full flex-col items-center`}>
         <div
            className={`flex w-2/5 flex-col items-start gap-2 text-wrap !text-main`}
         >
            <h2 className={`text-2xl !text-main`}>
               {APP_NAME} Terms of Service{" "}
            </h2>
            <h3 className={`text-base text-secondary`}>
               Last updated: {moment(LAST_UPDATED).format(`MMMM DD, YYYY`)}
            </h3>
            <Heading text={`1. Introduction`} />
            <p className={`mt-2`}>
               Welcome to {APP_NAME} ("we," "our," "us"). These Terms of Service
               ("Terms") govern your use of our website {APP_HOST_NAME}.com,
               services, and products (collectively, the "Services"). By
               accessing or using our Services, you agree to be bound by these
               Terms. If you do not agree to these Terms, please do not use our
               Services.
            </p>
            <Heading text={`2. Use of Services`} />
            <h3 className={`mt-2 font-semibold`}>2.1 Account Registration</h3>
            <p className={`mt-2`}>
            ...
            <h3 className={`mt-2 font-semibold`}>2.2 Prohibited activities</h3>
            ...
            <ul className={`list-disc`}>
               ...
               <li className={`ml-4 mt-2`}>
                  Engage in any activity that could harm, disrupt, or otherwise
                  negatively impact the Services or our users.
               </li>
               <li className={`ml-4 mt-2`}>
               ...
               <li className={`ml-4 mt-2`}>
                  Use any automated means to access the Services, including
            ...
            <h3 className={`mt-2 font-semibold`}>3.1 Subscription Terms</h3>
            <p className={`mt-2`}>
               Some of our Services may be available on a subscription basis. By
               subscribing to our Services, you agree to pay the applicable fees
               and charges in accordance with the subscription terms and pricing
               listed on our website.
            </p>
            <h3 className={`mt-2 font-semibold`}>3.2 Payment</h3>
            <p className={`mt-2`}>
               You authorize us to charge your chosen payment method for the
               subscription fees and any applicable taxes. All payments are
               non-refundable except as expressly stated in these Terms or as
            ...
            <p className={`mt-2`}>
               ...
               We will provide you with reasonable notice of any changes to the
               subscription fees. Your continued use of the Services after the
               fee changes take effect constitutes your agreement to pay the
               modified fees.
            </p>
            <Heading text={`4. Intellectual property`} />
            <h3 className={`mt-2 font-semibold`}>4.1 Ownership</h3>
            <p className={`mt-2`}>
               We and our licensors retain all right, title, and interest in and
               to the Services, including all related intellectual property
               rights. These Terms do not grant you any rights to use our
               trademarks, logos, or other intellectual property.
            </p>
            <h3 className={`mt-2 font-semibold`}>4.2 User Content</h3>
            <p className={`mt-2`}>
               You retain ownership of any content you submit, post, or
               otherwise make available through the Services ("User Content").
               By providing User Content, you grant us a non-exclusive,
               worldwide, royalty-free, sublicensable, and transferable license
               to use, reproduce, modify, distribute, and display your User
            ...
            <h3 className={`mt-2 font-semibold`}>6.1 Disclaimers</h3>
            <p className={`mt-2`}>
            ...
            <p className={`mt-2`}>
               ...
               of or inability to use the Services; (b) any unauthorized access
               ...
               from the Services; (d) any bugs, viruses, trojan horses, or the
               like that may be transmitted to or through the Services by any
               ...
               the Services; and/or (f) the defamatory, offensive, or illegal
            ...
            <h3 className={`mt-2 font-semibold`}>8.1 Governing Law</h3>
            <p className={`mt-2`}>
               These Terms shall be governed by and construed in accordance with
               the laws of Bulgaria, without regard to its conflict of law
               principles.
            </p>
            <h3 className={`mt-2 font-semibold`}>8.2 Dispute Resolution</h3>
            <p className={`mt-2`}>
               Any dispute arising out of or relating to these Terms or the
               Services shall be resolved through binding arbitration in
               accordance with the rules of the [American Arbitration
               Association/Other Organization]. The arbitration shall be
               conducted in [Your City/State]. You agree to waive any right to a
               trial by jury or to participate in a class action.
            </p>
            <Heading text={`9. Changes to these Terms`} />
            <p className={`mt-2`}>
               We may update these Terms from time to time. We will notify you
               of any changes by posting the new Terms on our website and
         ...
         <div className={`mt-8 flex w-2/5 items-center justify-end`}>
            <Link
               className={`inline-flex items-center gap-1 !text-main`}
               href={`/`}
            >
