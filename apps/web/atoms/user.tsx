...
export const userConfigAtom = atomWithStorage<UserConfiguration>(
   "user-configuration",
   null!
);
...
// @ts-ignore
export const userTestDifficultyAtom = atom(
   (get) => get(userConfigAtom)?.test_difficulty,
   (get, set, test_difficulty: string) =>
      set(userConfigAtom, {
         ...get(userConfigAtom),
         test_difficulty,
      })
...
// @ts-ignore
export const blindModeAtom = focusAtom<UserConfiguration["blind_mode"]>(
   userConfigAtom,
   (optic) => optic.prop(`blind_mode`)
);
...
export const userLanguageAtom = atom(
   ...
   (get, set, language: string) =>
      set(userConfigAtom, { ...get(userConfigAtom), language })
);

userLanguageAtom.debugLabel = `userLanguageAtom`;

// @ts-ignore
export const freedomModeAtom = focusAtom<
   UserConfiguration["input_freedom_mode"]
>(userConfigAtom, (optic) => optic.prop(`input_freedom_mode`));
freedomModeAtom.debugLabel = `freedomModeAtom`;

// @ts-ignore
export const autoSaveModeAtom = focusAtom<UserConfiguration["auto_save_mode "]>(
   userConfigAtom,
   (optic) => optic.prop(`auto_save_mode`)
);
autoSaveModeAtom.debugLabel = `autoSaveModeAtom`;

// @ts-ignore
export const confidenceModeAtom = focusAtom<
   UserConfiguration["input_confidence_mode"]
>(userConfigAtom, (optic) => optic.prop(`input_confidence_mode`));
confidenceModeAtom.debugLabel = `confidenceModeAtom`;

// @ts-ignore
export const soundOnClickAtom = focusAtom<
   UserConfiguration["sound_click_sound"]
>(userConfigAtom, (optic) => optic.prop(`sound_click_sound`));
soundOnClickAtom.debugLabel = `soundOnClickAtom`;

// @ts-ignore
export const soundOnErrorAtom = focusAtom<
   UserConfiguration["sound_error_sound"]
>(userConfigAtom, (optic) => optic.prop(`sound_error_sound`));
soundOnErrorAtom.debugLabel = `soundOnErrorAtom`;

// @ts-ignore
export const smoothCaretAtom = focusAtom<UserConfiguration["caret_smoothness"]>(
   userConfigAtom,
   (optic) => optic.prop(`caret_smoothness`)
);
smoothCaretAtom.debugLabel = `smoothCaretAtom`;

// @ts-ignore
export const caretStyleAtom = focusAtom<UserConfiguration["caret_style"]>(
   userConfigAtom,
   (optic) => optic.prop(`caret_style`)
);
caretStyleAtom.debugLabel = `caretStyleAtom`;

// @ts-ignore
export const paceCaretStyleAtom = focusAtom<
   UserConfiguration["pace_caret_style"]
>(userConfigAtom, (optic) => optic.prop(`pace_caret_style`));
paceCaretStyleAtom.debugLabel = `paceCaretStyleAtom`;

// @ts-ignore
export const paceCaretSpeedAtom = focusAtom<
   UserConfiguration["pace_caret_speed"]
>(userConfigAtom, (optic) => optic.prop(`pace_caret_speed`));
paceCaretSpeedAtom.debugLabel = `paceCaretSpeedAtom`;

// @ts-ignore
export const flipColorsAtom = focusAtom<UserConfiguration["theme_flip_colors"]>(
   userConfigAtom,
   (optic) => optic.prop(`theme_flip_colors`)
);
flipColorsAtom.debugLabel = `flipColorsAtom`;

// @ts-ignore
export const colorfulModeAtom = focusAtom<
   UserConfiguration["theme_colorful_mode"]
>(userConfigAtom, (optic) => optic.prop(`theme_colorful_mode`));
colorfulModeAtom.debugLabel = `colorfulModeAtom`;

// @ts-ignore
export const keyTipsAtom = atom<boolean>(
   (get) => get(userConfigAtom)?.elements_show_key_tips,
   (get, set, value: boolean) =>
      set(userConfigAtom, {
         ...get(userConfigAtom),
         elements_show_key_tips: value,
      })
);
keyTipsAtom.debugLabel = `keyTipsAtom`;

// @ts-ignore
export const oofWarningtom = focusAtom<
   UserConfiguration["elements_show_oof_warning"]
>(userConfigAtom, (optic) => optic.prop(`elents_show_oof_warning`));
oofWarningtom.debugLabel = `oofWarningtom`;

// @ts-ignore
export const capsLockWarningAtom = focusAtom<
   UserConfiguration["elements_show_caps_lock_warning"]
>(userConfigAtom, (optic) => optic.prop(`elements_show_caps_lock_warning`));
capsLockWarningAtom.debugLabel = `capsLockWarningAtom`;

// @ts-ignore
export const averageAtom = focusAtom<
   UserConfiguration["elements_show_average"]
>(userConfigAtom, (optic) => optic.prop(`elements_show_average`));
averageAtom.debugLabel = `averageAtom`;

// @ts-ignore
export const fontFamilyAtom = atom(
   (get) => get(userConfigAtom)?.font_family,
   (get, set, font: string) =>
      set(userConfigAtom, {
         ...get(userConfigAtom),
         font_family: font,
...
// @ts-ignore
export const fontSizeAtom = focusAtom<number>(userConfigAtom, (optic) =>
   optic?.prop(`font_size`)
);
...
// @ts-ignore
export const customThemesAtom = atom<Record<string, string>[]>(
   (get) => get(userConfigAtom)?.metadata?.customThemes ?? [],
   (get, set, themes: any[]) =>
      set(userConfigAtom, {
         ...get(userConfigAtom),
         metadata: {
